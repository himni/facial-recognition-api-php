...
/**
 * PersonCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PersonCreateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Person-CreateRequest';
...
'person_group_uuid' => null    ];
    ...
    protected static $attributeMap = [
        'name' => 'name',
'meta' => 'meta',
'person_group_uuid' => 'person_group_uuid'    ];
    ...
    protected static $setters = [
        'name' => 'setName',
'meta' => 'setMeta',
'person_group_uuid' => 'setPersonGroupUuid'    ];
    ...
    protected static $getters = [
        'name' => 'getName',
'meta' => 'getMeta',
'person_group_uuid' => 'getPersonGroupUuid'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['person_group_uuid'] = isset($data['person_group_uuid']) ? $data['person_group_uuid'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['person_group_uuid'] === null) {
            $invalidProperties[] = "'person_group_uuid' can't be null";
        }
    ...
    /**
     * Gets person_group_uuid
     *
     * @return string
     */
    public function getPersonGroupUuid()
    {
        return $this->container['person_group_uuid'];
    }

    /**
     * Sets person_group_uuid
     *
     * @param string $person_group_uuid person_group_uuid
     *
     * @return $this
     */
    public function setPersonGroupUuid($person_group_uuid)
    {
        $this->container['person_group_uuid'] = $person_group_uuid;
